...
export declare function createTelegramDm(config: TelegramDmConfig): TelegramDm;
...
export declare function createEscalationNotifier(config: EscalationNotifierConfig): EscalationNotifier;
