...
export type EnvOf<S extends EnvSchema> = {
    readonly [K in keyof S]: S[K]['value'];
};
...
export declare function str(options?: StrOptions & {
    optional?: false;
    default?: string;
}): EnvField<string>;
export declare function str(options: StrOptions & {
...
export declare function num(options?: NumOptions & {
    optional?: false;
    default?: number;
}): EnvField<number>;
export declare function num(options: NumOptions & {
    optional: true;
}): EnvField<number | null>;
export declare function bool(options?: CommonOptions & {
    optional?: false;
    default?: boolean;
}): EnvField<boolean>;
export declare function bool(options: CommonOptions & {
    optional: true;
}): EnvField<boolean | null>;
...
export declare function enumOf<const V extends readonly [string, ...string[]]>(values: V, options?: CommonOptions & {
    optional?: false;
    default?: V[number];
}): EnvField<V[number]>;
export declare function enumOf<const V extends readonly [string, ...string[]]>(values: V, options: CommonOptions & {
 ...
 * is installed.
 */
export type CustomSchema<T> = z.ZodType<T, any, any> & {
    _input: string;
};
/**
 ...
 */
export declare function renderEnvExample(schema: EnvSchema, options?: RenderEnvExampleOptions): string;
export {};
